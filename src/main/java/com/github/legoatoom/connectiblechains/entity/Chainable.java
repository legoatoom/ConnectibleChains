...
public interface Chainable {
    ...
    static <E extends Entity & Chainable> void tickChain(ServerWorld world, E entity) {
        ...
        for (ChainData chainData : chainDataSet) {
            Entity chainHolder = chainData.chainHolder;
            if (chainHolder != null) {
    ...
    default void addUnresolvedChainHolderId(int unresolvedChainHolderId, Item sourceItem) {
        this.replaceChainData(null, new ChainData(unresolvedChainHolderId, sourceItem));
    }
    ...
    public static final class ChainData {
        ...
        public boolean equals(Object o) {
            ...
            return unresolvedChainHolderId == chainData.unresolvedChainHolderId && Objects.equals(chainHolder, chainData.chainHolder) && Objects.equals(unresolvedChainData, chainData.unresolvedChainData);
        }

        @Override
        public int hashCode() {
            return Objects.hash(unresolvedChainHolderId, chainHolder, unresolvedChainData);
        }
    }
}
